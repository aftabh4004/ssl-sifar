...
from sifar_pytorch.video_dataset import VideoDataSet, VideoDataSetLMDB
from dataset import VideoDataSetOnlineSSL
...
#    std = IMAGENET_DEFAULT_STD
    ...
    if args.use_lmdb:
        ...
        video_data_cls = VideoDataSetOnlineSSL
    else:
    ...
    dataset_unlabeled_train = video_data_cls(args.data_dir, train_unlabel_list, args.duration, args.frames_per_group,
                                    ...
                                    dense_sampling=args.dense_sampling,
                                    transform=train_augmentor, is_train=True, test_mode=False,
                                    seperator=filename_seperator, filter_video=filter_video, isLabeled=False)
    ...
    data_loader_unlabeled_train = build_dataflow(dataset_unlabeled_train, is_train=True, batch_size=args.batch_size,
                                       workers=args.num_workers, is_distributed=args.distributed)
